...
enum parameters {T_VAR,K_VAR,LAMBDA,U_VAR,PSI,DELTA,N_VAR};
...
class mesh{
    ...
    public:
        void setParameters(float t_var,float k_var,float lambda,float u_var,float psi,float delta,float n_var){
            parameters[T_VAR]=t_var;
            parameters[K_VAR]=k_var;
            parameters[LAMBDA]=lambda;
            parameters[U_VAR]=u_var;
            parameters[PSI]=psi;
